...
parser.add_argument("--dataset", default="/home/ypf/yu_work/TestSet/B100", type=str, help="dataset name, Default: Set5")
    ...
    for scale in scales:
        ...
        for image_name in image_list:
            if "_x" + str(scale) in image_name:
                ...
                score = compare_ssim(im_gt_y, im_b_y, multichannel=True)
                ...
                im_h_y = HR.data[0].numpy().astype(float)
                ...
                (score, diff) = compare_ssim(im_gt_y, im_h_y, full=True)
                avg_ssim_predicted += score


                del im_gt_y, im_b_y, im_input, HR, im_h_y

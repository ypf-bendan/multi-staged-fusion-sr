...
im_gt_ycbcr = imread("pic_test/" + opt.image + ".png", mode="YCbCr")
im_b_ycbcr = imread("pic_test/"+ opt.image + "_scale_"+ str(opt.scale) + ".png", mode="YCbCr")
...
imsave('pic_test/buffery_MF_x3.png', im_h)
